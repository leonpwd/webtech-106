...
export default function PostDetail({ id }: { id: string }) {
    ...
    return (
        <div className="max-w-4xl mx-auto px-4 py-8">
            <Link href="/forum" className="inline-flex items-center gap-2 text-neutral-400 hover:text-white mb-8">
                ...
                <div className="flex justify-between items-start">
                    ...
                    {isAuthor && (
                        <div className="flex gap-2">
                            <Link href={`/forum/edit/${post.id}`} className="p-2 text-neutral-400 hover:text-white bg-white/5 rounded">
                                <FaEdit />
                            </Link>
                            <button onClick={handleDelete} className="p-2 text-neutral-400 hover:text-red-500 bg-white/5 rounded">
                                <FaTrash />
                            </button>
                        </div>
                    )}
