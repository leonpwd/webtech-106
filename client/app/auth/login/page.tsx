      ...
      <Card>
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="mt-4">
              <div className="text-sm text-muted-foreground mb-2">Ou se connecter avec</div>
              <div className="flex flex-wrap gap-2">
                <Button className="w-full sm:w-auto" variant="outline" onClick={handleGitHubOAuth} disabled={loading}>
                  {loading ? 'Ouverture…' : (
                    <>
                ...
                <Button className="w-full sm:w-auto" variant="outline" onClick={handleDiscordOAuth} disabled={loading}>
                  {loading ? 'Ouverture…' : (
                    <>
                      <span className="mr-2 inline-flex items-center" aria-hidden>
